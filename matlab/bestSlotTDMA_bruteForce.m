...
all_min_CTR_index = find( average_CTR_delay == min_CTR); 
[min_ROV,min_ROV_index] = min(average_ROV_delay);
min_ROV_matrix = rand_matrix(:,:,min_ROV_index);
all_min_ROV_index = find( average_ROV_delay == min_ROV); 
[min_sum,min_sum_index] = min(average_ROV_delay+average_CTR_delay);
average_sum_delay = average_ROV_delay+average_CTR_delay;
min_sum_matrix = rand_matrix(:,:,min_sum_index);
all_min_sum_index = find( average_sum_delay == min_sum); 
