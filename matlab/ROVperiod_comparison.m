...
range = 1:1:60;
dir = '';
load(['ROV_period',dir,'/figure/simTDMA_1Relay.mat']);
...
%2 Relay
load(['ROV_period',dir,'/figure/simTDMA_2Relay.mat']);
...
%3 realay
load(['ROV_period',dir,'/figure/simTDMA_3Relay.mat']);
...
xlabel('ROV period [s]');
ylabel('ROV throughput [bit/s]');
legend('ROV throughput 1 realay','theoretical min ROV period',...
    'ROV throughput 2 relay','theoretical min ROV period 2 relay',...
    'ROV throughput 3 relay','theoretical min ROV period 3 relay');
axis([1 60 0 250]);
