...
%hold on;
errorbar(range, adap_ROV_pdd,adap_ROV_pdd_CI,'-r*','MarkerSize',5);
grid on;
hold on;
set(gca, 'YScale', 'log')
axis([1 60 1 10^4]);
...
errorbar(range, adap_CTR_pdd,adap_CTR_pdd_CI,'-r*','MarkerSize',5);
grid on;
hold on;
set(gca, 'YScale', 'log')
axis([1 60 1 10^4]);
...
errorbar(range, adap_ROV_pdd,adap_ROV_pdd_CI,'-bo','MarkerSize',4.5,'MarkerFaceColor','b');
grid on;
hold on;
set(gca, 'YScale', 'log')
if strcmp(dir,'1')
...
errorbar(range, adap_CTR_pdd,adap_CTR_pdd_CI,'-bo','MarkerSize',4.5,'MarkerFaceColor','b');
grid on;
hold on;
set(gca, 'YScale', 'log')
if strcmp(dir,'1')
...
if (strcmp(dir,'2') || strcmp(dir,'3'))
    ...
    errorbar(range, adap_ROV_pdd,adap_ROV_pdd_CI,'-g^','MarkerSize',4,'MarkerFaceColor','g');   
    grid on;
    hold on;
    set(gca, 'YScale', 'log')
    title('ROV packet delivery delay');
    ...
    errorbar(range, adap_CTR_pdd,adap_CTR_pdd_CI,'-g^','MarkerSize',4,'MarkerFaceColor','g');
    grid on;
    hold on;
    set(gca, 'YScale', 'log')
    title('CTR packet delivery delay');
...
if strcmp(dir,'3')
    ...
    errorbar(range, adap_ROV_pdd,adap_ROV_pdd_CI,'-mx','MarkerSize',8);    
    grid on;
    hold on;
    set(gca, 'YScale', 'log')
    title('ROV packet delivery delay');
    ...
    errorbar(range, adap_CTR_pdd,adap_CTR_pdd_CI,'-mx','MarkerSize',8);    
    grid on;
    hold on;
    set(gca, 'YScale', 'log')
    title('CTR packet delivery delay');
