...
for k = range
    i = i+1;
    load(['ROV_period/',dir,'/adaptiveROVpath_ROVperiod',int2str(k),'.mat'])
    adap_rmse(i) = rmse;
...
axis([1 60 10^-3 1000]);
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'_RMSE.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'_RMSE.png']);
    saveas(gcf,['ROV_period/figure/',dir,'_RMSE.eps']);
end
...
axis([1 60 0 300]);
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'_ROV_th.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'_ROV_th.png']);
    saveas(gcf,['ROV_period/figure/',dir,'_ROV_th.eps']);
end
...
axis([1 60 0 550]);
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'_CTR_th.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'_CTR_th.png']);
    saveas(gcf,['ROV_period/figure/',dir,'_CTR_th.eps']);
end
...
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'ROV_pdr.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'ROV_pdr.png']);
    saveas(gcf,['ROV_period/figure/',dir,'ROV_pdr.eps']);
end
...
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'CTR_pdr.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'CTR_pdr.png']);
    saveas(gcf,['ROV_period/figure/',dir,'CTR_pdr.eps']);
end
...
axis([1 60 0 50]);
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'_CTRpdd.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'_CTRpdd.png']);
    saveas(gcf,['ROV_period/figure/',dir,'_CTRpdd.eps']);
end
...
if save_flag == 1
    savefig(['ROV_period/figure/',dir,'_ROVpdd.fig']);
    saveas(gcf,['ROV_period/figure/',dir,'_ROVpdd.png']);
    saveas(gcf,['ROV_period/figure/',dir,'_ROVpdd.eps']);
end



if save_flag == 1
    save(['ROV_period/figure/',dir,'.mat'],'adap_rmse','adap_ROV_pdr',...
