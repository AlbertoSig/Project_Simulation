...
title('Buffer size Relay R1 (AUV period 1)');
xlabel('time [s]');
ylabel('buffer size');
%hold on;
grid on;
...
grid on;
title('Buffer size Relay R2 (AUV period 1)');
xlabel('time [s]');
ylabel('buffer size');
axis([0 40000 0 3]);
subplot(4,1,3)
...
grid on;
title('Buffer size Relay R3 (AUV period 1)');
xlabel('time [s]');
ylabel('buffer size');
axis([0 40000 0 3]);
subplot(4,1,4)
...
grid on;
axis([0 40000 0 3]);
title('Buffer size Relay R4 (AUV period 1)');
xlabel('time [s]');
ylabel('buffer size');
...
title('Buffer size Relay R1 (AUV period 30)');
xlabel('time [s]');
ylabel('buffer size');
%hold on;
grid on;
...
grid on;
title('Buffer size Relay R2 (AUV period 30)');
xlabel('time [s]');
ylabel('buffer size');
axis([0 40000 0 3]);
subplot(4,1,3)
...
grid on;
title('Buffer size Relay R3 (AUV period 30)');
xlabel('time [s]');
ylabel('buffer size');
axis([0 40000 0 3]);
subplot(4,1,4)
...
grid on;
axis([0 40000 0 3]);
title('Buffer size Relay R4 (AUV period 30)');
xlabel('time [s]');
ylabel('buffer size');
...
title('Buffer size Relay R1 (AUV period 60)');
xlabel('time [s]');
ylabel('buffer size');
%hold on;
grid on;
...
grid on;
title('Buffer size Relay R2 (AUV period 60)');
xlabel('time [s]');
ylabel('buffer size');
axis([0 40000 0 3]);
subplot(4,1,3)
...
grid on;
title('Buffer size Relay R3 (AUV period 60)');
xlabel('time [s]');
ylabel('buffer size');
axis([0 40000 0 3]);
subplot(4,1,4)
...
grid on;
axis([0 40000 0 3]);
title('Buffer size Relay R4 (AUV period 60)');
xlabel('time [s]');
ylabel('buffer size');
