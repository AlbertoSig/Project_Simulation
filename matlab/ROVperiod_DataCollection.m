...
for period = range
    ...
    if save_flag == 1
        savefig(['ROV_period/',dir,'/adaptiveROVpath_ROVperiod',int2str(ROV_period),ack,'.fig'])
        saveas(gcf,['ROV_period/',dir,'/adaptiveROVpath_ROVperiod',int2str(ROV_period),ack,'.png']);
        save(['ROV_period/',dir,'/adaptiveROVpath_ROVperiod',int2str(ROV_period),'.mat']);
    end
